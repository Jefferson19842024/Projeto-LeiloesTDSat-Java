...
public class cadastroVIEW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcbxStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Vendido.", "A Venda" }));
    ...
    private void cadastroNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastroNomeActionPerformed
     ...
     private void setupComboBox() {
        jcbxStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A Venda", "Vendido" }));
    }
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try {
            ...
            produto.setStatus((String) jcbxStatus.getSelectedItem());
